...
class TestYFinanceAdapterSearch:
    ...
    def sample_search_query(self):
        ...
        return AssetSearchQuery(
            query="Apple", asset_types=[AssetType.STOCK], limit=10, language="en-US"
        )
    ...
    def test_search_assets_with_yfinance_search_success(
        self, adapter, sample_search_query, mock_search_quotes
    ):
    ...
    def test_search_assets_fallback_to_direct_lookup(
        self, adapter, sample_search_query
    ):
    ...
    def test_search_assets_limit_results(self, adapter, mock_search_quotes):
        ...
        with patch("valuecell.adapters.assets.yfinance_adapter.yf") as mock_yf:
            ...
            query = AssetSearchQuery(query="Apple", limit=2, language="en-US")
    ...
    def test_search_assets_relevance_scoring(self, adapter, mock_search_quotes):
        ...
        with patch("valuecell.adapters.assets.yfinance_adapter.yf") as mock_yf:
            ...
            query = AssetSearchQuery(query="Apple", limit=10, language="en-US")
    ...
    def test_calculate_search_relevance(self, adapter):
        ...
        score = adapter._calculate_search_relevance(
            high_relevance_quote, "AAPL", "Apple Inc."
        )
        ...
        score = adapter._calculate_search_relevance(
            low_relevance_quote, "AAPL", "Apple Inc."
        )
    ...
    def test_fallback_ticker_search(self, adapter):
        ...
        with patch("valuecell.adapters.assets.yfinance_adapter.yf") as mock_yf:
            ...
            query = AssetSearchQuery(query="AAPL", limit=10, language="en-US")
    ...
    def test_fallback_ticker_search_with_suffixes(self, adapter):
        ...
        with patch("valuecell.adapters.assets.yfinance_adapter.yf") as mock_yf:
            ...
            query = AssetSearchQuery(query="0700", limit=10, language="en-US")
    ...
    def test_search_assets_empty_query(self, adapter):
        ...
        query = AssetSearchQuery(query="", limit=10, language="en-US")
    ...
    def test_search_assets_no_results(self, adapter):
        ...
        query = AssetSearchQuery(query="NONEXISTENTSTOCK", limit=10, language="en-US")
    ...
    @pytest.mark.parametrize(
        "exchange_code,expected_exchange",
        [
            ("NMS", "NASDAQ"),
            ("NYQ", "NYSE"),
            ("ASE", "AMEX"),
