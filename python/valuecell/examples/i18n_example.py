...
try:
    ...
    print("Try: cd /path/to/valuecell/python && python -m valuecell.examples.i18n_example")
    sys.exit(1)
...
def main():
    ...
    timezones = ["UTC", "America/New_York", "Europe/London", "Asia/Shanghai", "Asia/Hong_Kong"]
