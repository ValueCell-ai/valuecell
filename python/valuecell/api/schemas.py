...
class TranslationRequest(BaseModel):
    ...
    variables: Optional[Dict[str, Any]] = Field(default_factory=dict, description="Variables for string formatting")


class DateTimeFormatRequest(BaseModel):
    """DateTime formatting request."""
    datetime: str = Field(..., description="ISO datetime string")
    format_type: str = Field("datetime", description="Format type: date, time, or datetime")
